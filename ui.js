...
function renderWithPage(index){
    ...
    warn.innerHTML = "NOTE: This shows the thumbnails as of " + (new Date(theJSON.lastUpdated*1000)).toLocaleString() + "and will <strong>NOT</strong> be updated due to technical limitations, thanks for understanding.";
